...
export const EVENTS: Event[] = [
  {
    ...
    description: 'Its a Highly Anticipated Movie From Super Star Rajnikanth , Our Thalaiva and Director Lokesh Kanagaraj Marked for His excellence for Scripts like Vikram Hitlist , Khaidi , LEO .',
