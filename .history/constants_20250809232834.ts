...
export const LOGO_URL = 'https://i.postimg.cc/6p2DsC2p/qr.png';
...
export const EVENTS: Event[] = [
  ...
  {
    id: 'free-workshop-2025',
    organizerId: 'org-2',
    name: 'Free Coding Workshop',
    date: '2025-11-15T10:00:00Z',
    venue: 'Community Hall',
    description: 'A free workshop for beginners to learn the basics of web development. No payment required to book a spot.',
