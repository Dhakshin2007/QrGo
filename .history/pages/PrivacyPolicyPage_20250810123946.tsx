...
const PrivacyPolicyPage: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto animate-fade-in p-4 sm:p-6 lg:p-8">
      <Link to="/" className="flex items-center gap-2 mb-6 text-primary hover:underline">
      ...
      <div className="bg-surface rounded-lg shadow-xl p-8">
        ...
        <div className="space-y-4 text-on-surface-secondary">
          ...
          <h2 className="text-2xl font-semibold text-on-surface pt-4">Contact Us</h2>
          <p>
            If you have any questions about our privacy practices, please feel free to <a href="mailto:kothadhakshin123@gmail.com" className="text-primary hover:underline">contact us</a>.
          </p>
        </div>
      </div>
    </div>
