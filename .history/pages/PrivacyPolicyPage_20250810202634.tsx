...
// Reusable component for the branded link to keep the JSX clean.
const QrGoLink = () => (
    <a href="https://qrgo-weld.vercel.app/" target="_blank" rel="noopener noreferrer" className="font-bold text-primary hover:underline">QrGo</a>
);
      ...
      <div className="bg-surface rounded-lg shadow-xl p-8">
        ...
        <div className="space-y-8 text-on-surface-secondary">
            ...
            <section className="space-y-4">
                ...
                <h3 className="text-xl font-semibold text-on-surface">Sharing</h3>
                ...
                <h3 className="text-xl font-semibold text-on-surface">Security Precautions</h3>
                ...
                <h3 className="text-xl font-semibold text-on-surface">Data Deletion and Retention</h3>
                ...
                <h3 className="text-xl font-semibold text-on-surface">Your Rights</h3>
                <p>You may access, rectify, and update your personal data directly through the functionalities provided on the Platform.</p>
                
                <h3 className="text-xl font-semibold text-on-surface">Consent</h3>
                ...
                <h3 className="text-xl font-semibold text-on-surface">Changes to this Privacy Policy</h3>
            ...
            <section className="space-y-4">
                <h2 className="text-2xl font-bold text-on-surface">Terms &amp; Conditions</h2>
                <p>This document is an electronic record in terms of Information Technology Act, 2000 and rules there under as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <QrGoLink />, including the related mobile site and mobile application (hereinafter referred to as “Platform”). The Platform is owned by <QrGoLink />, a company incorporated under the Companies Act, 1956 with its registered office at IIT ROPAR (hereinafter referred to as "Platform Owner", “we”, “us”, “our”).</p>
                ...
                <p>These Terms and any dispute or claim relating to it, or its enforceability, shall be governed by and construed in accordance with the laws of India. All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Rupnagar,Punjab</p>
            ...
            {/* <section className="space-y-4">
                ...
                <p>All orders are delivered within 2-3 business days. Orders are not shipped or delivered on weekends or holidays. If we are experiencing a high volume of orders, shipments may be delayed by a few days. Please allow additional days in transit for delivery. If there will be a significant delay in the shipment of your order, we will contact you via email or phone.</p>
                
                <h3 className="text-xl font-semibold text-on-surface">Shipping Time</h3>
                <p>Domestic Shipping: Orders will be delivered within 3 to 4 weeks from the date of order confirmation. Please note that delivery times may be affected by factors beyond our control, such as weather conditions, customs delays, and other unforeseen circumstances.</p>
            </section>

            <section className="space-y-4">
                <h2 className="text-2xl font-bold text-on-surface">Return and Refund policy</h2>
                
                <h3 className="text-xl font-semibold text-on-surface">Return</h3>
